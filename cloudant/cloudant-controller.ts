...
const account: string = appSecretKeyJson.cloudant.username;
const key: string = appSecretKeyJson.cloudant.apiKey;
const password: string = appSecretKeyJson.cloudant.apiPassword;
